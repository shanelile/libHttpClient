...
#define HC_PLATFORM_CENTENNIAL 4
...
(HC_PLATFORM == HC_PLATFORM_WIN32 || HC_PLATFORM == HC_PLATFORM_UWP || HC_PLATFORM == HC_PLATFORM_XDK || HC_PLATFORM == HC_PLATFORM_CENTENNIAL)
#endif
